...
const gambleButtonColor = document.getElementById("gambleButton");
let trekkAntall = 0;
let limeJackpots = 0;
let melonJackpots = 0;
let lemonJackpots = 0;
...
async function trekk() {
  if (spinning === false) {
    spinning = true;
    gambleButtonColor.style.backgroundColor = "grey";
    let array;
    trekkAntall++;
    ...
    let screen2 = "";
    let screen3 = "";
    screens.s1.innerText=screen1;
    screens.s2.innerText=screen2;
    screens.s3.innerText=screen3;
      ...
      spinning = false;
      gambleButtonColor.style.backgroundColor = "lightgrey";
  }
}